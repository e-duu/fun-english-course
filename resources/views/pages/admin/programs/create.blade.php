...
@endif
  <div class="w-full flex justify-end">
    <a href="{{ route('program.all') }}" class="my-2 bg-yellow-400 px-4 py-2 text-sm rounded-md transition-colors duration-150 ease-linear text-white focus:outline-none focus:ring-0 font-semibold hover:bg-yellow-700">Back to Level</a>
  </div>
