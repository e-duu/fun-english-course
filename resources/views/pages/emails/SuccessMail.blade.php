...
<html lang="en">
    <head>
        ...
        <title>Payment Success Mail</title>
        <style>
            body[yahoo] body{
                padding: 20px;
    ...
    <body yahoo>
        ...
        <table bgcolor="#06f52d" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <a style="text-decoration: none; color: #fff;" href="{{route('spp-payment', $data->id)}}">View Detail</a>
                </td>
            </tr>
        </table>
    </body>
