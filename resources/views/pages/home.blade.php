    ...
    <div class="grid grid-cols-12 gap-14 items-start">
      <aside class="col-span-4 h-full bg-blue-200 flex-col py-8 rounded-sm">
        <div class="px-14">
          ...
          <h3 class="text-center py-3 text-black font-bold text-2xl mt-5 bg-blue-100 rounded-sm shadow-lg">{{ auth()->check() ? auth()->user()->name : 'saya belom login' }}</h3>
        </div>
              ...
              <div class="shadow-lg">
                ...
                <div class="bg-blue-100 py-3 rounded-b-sm">
                  @foreach ($program->levels as $level)
                    <a href="{{ route('resource.detail', $level->name) }}">
      ...
      <section class="col-span-8">
        <header>
          ...
          <div class="flex-col bg-[rgb(244,182,1)] p-5 mt-10 shadow-lg">
            <h3 class="text-[rgb(1,131,215)] font-bold text-xl uppercase"> Program : </h3>
            <h3 class="text-[rgb(1,131,215)] mt-5 font-bold text-xl uppercase"> Level : </h3>
          </div>
        </header>
        <main>
                ...
                <div class="shadow-lg">
                  ...
                  <div class="bg-blue-100 py-3 flex-col rounded-b-sm">
                    @foreach ($lesson->materials as $material)
                      <a href="{{ route('watch', [$lesson->id, $material->id]) }}" class="flex items-center space-x-5 py-3 text-[rgb(1,131,215)] hover:text-white hover:bg-blue-400 transition-colors duration-150 pl-20">
