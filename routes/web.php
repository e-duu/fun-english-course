...
Route::middleware(['auth'])->group(function ()
{
    ...
    Route::get('/resource/{name}', [ResourceController::class, 'detail'])->name('resource.detail');
    
    // Payment
    Route::get('/payment', [PaymentPageController::class, 'index'])->name('payment');
    
    // Watch Material
    Route::get('/watch/{lessonId}/{materialsId}', [WatchController::class, 'index'])->name('watch');
